...
if __name__ == '__main__':
    ...
    save_str = 'mnist_vgg16_channel_iteration_specs'
    ...
    # experimentally determined 1e-5 is too large for lambda
    space = VggParamSpace(expected_lam = 5e-8, max_lam = 1e-5, prob_max_lam = 1e-2,
    ...
    best_params, trials = tune_parameters(model=model,
                                          ...
                                          num_epoch= 2,
                                          max_evals= 40,
                                          epoch_updates= [-1]) # epoch updates = -1 for no epoch updates (Not best solution)
