...
if __name__ == '__main__':
    ...
    save_str = 'mnist_resnet18_channel_cosine_specs'
    ...
    # Keeping same ResNetParam space for all ResNet18 mnist classification models
    space = ResNetParamSpace(expected_lam = 1e-8, max_lam = 2.5e-6, prob_max_lam = 1e-2,
