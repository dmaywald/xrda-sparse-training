...
if __name__ == '__main__':
    ...
    save_str = 'cifar100_resnet50_kernel_cosine_specs'
    data = 'cifar100'
    ...
    if subset_Data is None:
        max_iter = math.ceil(50000/train_batch_size) * num_epoch # 50000 is length of CIFAR100 data
