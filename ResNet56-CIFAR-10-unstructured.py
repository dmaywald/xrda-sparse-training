...
def main():
  output_file = 'resnet56_sparse_model_cosine_1p3en6.dat'
  batch_size = 128
  epoch_count = 600
  ...
  training_specs = CosineSpecs(max_iter=math.ceil(50000/batch_size)*epoch_count,
      init_step_size=init_lr, mom_ts=12.37, b_mom_ts=12.37, weight_decay=5e-4)
  ...
  torch.save(conv_net.state_dict(), output_file)
