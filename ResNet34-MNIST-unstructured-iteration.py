...
if __name__ == '__main__':
    ...
    save_str = 'mnist_resnet34_unstructured_iteration_specs'
    ...
    space = ResNetParamSpace(expected_lam = 1.6e-6, max_lam = 5e-4, prob_max_lam = 1e-2,
