# -*- coding: utf-8 -*-
"""
Created on Sun Feb  4 16:02:40 2024
...
class mnist_densenet(nn.Module):

    def __init__(self, depth=40, 
        dropRate=0, dataset='mnist', growthRate=12, compressionRate=1, cfg = None):
