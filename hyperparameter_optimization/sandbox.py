...
def objective_function(params, k_folds = K_FOLDS, num_epoch = 2):
    """
    Parameters
    ----------
    params : dict
...
def bayesian_optimizer():
    best_params = fmin(fn = objective_function, space = space, algo= tpe.suggest, max_evals= max_evals, trials = Trials())
    return best_params
